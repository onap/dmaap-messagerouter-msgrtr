...
public class TopicServiceImplTest {
    ...
    @Test
    public void createTopic_withEnforcedTopicName_andUserIsInContext_shouldFail() throws Exception {
        //given
        thrown.expect(DMaaPAccessDeniedException.class);

        String topicName = "org.onap.dmaap.mr.topic-1";
    ...
    @Test
    public void createTopic_withNotEnforcedTopicName_andUserIsInContext_shouldPass() throws Exception {
        //given
        String topicName = "notEnforcedTopicName";
        givenTopicBean(topicName);
    ...
    @Test
    public void createTopic_noUserInContext_andNoAuthHeader_shouldPass_whenCADIdisabled() throws Exception {
        //given
    ...
    @Test
    public void createTopic_noUserInContext_andNoAuthHeader_shouldPass_whenCADIenabled() throws Exception {
        //given
    ...
    @Test
    public void createTopic_noUserInContext_andAuthHeader_shouldUseAAFauthorization_andPass() throws Exception {
        //given
    ...
    @Test
    public void createTopic_noUserInContext_andAuthHeader_shouldUseAAFauthorization_andFail() throws Exception {
        //given
        thrown.expect(DMaaPAccessDeniedException.class);
